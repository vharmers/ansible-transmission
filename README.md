...
| -------- | ------- | ----------- |
| transmission_enable | yes | Controls the running and startup state of the Transmission service |
...
| transmission_utp_enable | yes | Enable Micro Transport Protocol |
| transmission_port_forwarding_enable | no | Enable UPnP or NAT-PMP |
...
| transmission_speed_limit_down_enable | yes | Enable download speed limit |
| transmission_speed_limit_down | 5000 | The download limit in KB/s |
| transmission_speed_limit_up_enable | yes | Enable upload speed limit |
| transmission_speed_limit_up | 1000 | The upload limit in KB/s |
| transmission_alt_speed_enable | no | Enable alternate speed profile |
...
| transmission_alt_speed_time_enable | no | Enable alternate speed time schedule |
...
| transmission_ratio_limit_enable | no | Enable ratio seeding limit |
| transmission_ratio_limit | 2 | Ratio seeding limit |
| transmission_download_queue_enable | yes | Enable download queue |
| transmission_download_queue_size | 5 | Maximum amount of simultaneously downloaded torrents |
| transmission_seed_queue_enable | no | Enable seed queue |
| transmission_seed_queue_size | 10 | Maximum amount of simultaneously seeded torrents |
| transmission_idle_seeding_limit_enable | no | Enable idle seeding limit. This will stop the seeding of a torrent after is has been idle for a certain amount of time |
...
| transmission_queue_stalled_enable | yes | When enabled, torrents that have not seen any activity for a specified amount of time, are not counted towards the seed and download queue limits |
...
| transmission_incomplete_dir_enable | no | Store files of incomplete torrents in a separate directory |
...
| transmission_scrape_paused_torrents_enable | yes | Send tracker scraping requests for paused torrents |
...
| transmission_prefetch_enable | yes | Enable prefetch |
| transmission_cache_size_mb | 4 | Cache size in MB |
| transmission_watch_dir_enable | no | Watch a particular directory for new torrent files and add them |
| transmission_watch_dir | `"{{ transmission_user_home_dir }}/watch"` | Path to the directory to watch |
| transmission_pex_enable | yes | Enable Peer Exchange |
| transmission_lpd_enable | no | Enable Local Peer Discovery |
...
| transmission_rpc_enable | yes | Enable RPC |
...
| transmission_dht_enable | yes | Enable Distributed Hash Table |
